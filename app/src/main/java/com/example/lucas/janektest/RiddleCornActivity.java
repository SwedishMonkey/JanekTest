...
public class RiddleCornActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riddle_corn);

        AnswerText = (EditText)findViewById(R.id.cornRiddleAnswer);
    ...
    public void CheckCornAnswer(View view) {
        if (AnswerText.getText().toString().toLowerCase().equals("majskolv")) {
            bombTimer.cancel();
